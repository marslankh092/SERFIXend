...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.Holder>{
    ...
    public MyAdapter(ArrayList<ProductModel> arrayList, Context context, ItemClickListener itemClickListener) {
    ...
    public void onBindViewHolder(@NonNull MyAdapter.Holder holder, int position) {
        ...
        holder.price_product.setText("PKR "+arrayList.get(position).getPrice());
