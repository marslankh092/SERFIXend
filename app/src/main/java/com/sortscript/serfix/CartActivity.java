...
public class CartActivity extends AppCompatActivity implements CartAdapter.ItemClickListener {
    ...
    public void firebaseData() {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Serfix").child("Carts").child(UID);
    ...
    public void delete_firebaseData(String key) {
        ...
        UID = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Serfix").child("Carts").child(UID).child(key);
        ref.removeValue();
        setAdapter();
        progressDialog.dismiss();
